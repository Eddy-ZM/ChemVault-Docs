...
- 导航：上一节：[8.4 Enzyme control 与 ATCase](/uom-chemistry/chem10712_knowledge_points/08-04-enzyme-control-与-atcase/)；下一节：[8.6 如何从 MM plot 读参数](/uom-chemistry/chem10712_knowledge_points/08-06-如何从-mm-plot-读参数/)
